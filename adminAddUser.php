  ...
  display: block;
    ...
    <body>
       <div class="top">
          ...
          <a class="active" href="adminAddUser.php">Add User</a>
       ...
       <div class="content">
        ...
        <table>
         ...
         <input type="submit" id="add" name="submit" value="Create New Account"><br><br>
        </center>
...
$s="SELECT * from employee_profile where USERNAME='$uname'";
 ...
 $row=mysqli_num_rows($result);
     ...
     if($row==1)
   {
    $msg1="USER PROFILE Already EXISTS!!!";
    $msg2="Try With Another USER!!!";
    echo "<script type='text/javascript'>alert('$msg1 $msg2'); </script> ";
   
    }
    else{
       
        $sql="insert into employee_profile (FULLNAME,USERNAME,PASSWORD,ADDRESS,CITY,STATE_PROVIENCE_REGION,POSTALCODE_ZIP,POSITION,EMAIL,PERMISSION_LEVEL)
